...
@Component({
  selector: 'app-eip-equipe',
  templateUrl: './eip-equipe.component.html',
  styleUrls: ['./eip-equipe.component.scss']
})
export class EipEquipeComponent implements OnInit {

  user: User;
  entretient: Entretien[] = [];
  collaborateur = false;
	//Mat table
	displayedColumns: string[] = ['position', 'Collaborateur','Compagne','Status'];
