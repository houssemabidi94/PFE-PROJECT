...
//	}
	...
	@GetMapping("descbycomp/{idCompetence}")
	public List<Description> getDescriptionByCompetenceId(@PathVariable("idCompetence") long id) {
		return descriptionService.getDescByCompetence(id);
